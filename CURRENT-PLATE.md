...
**He walks in front of it properly.** Both are white line art at the same weight
on the same ground, so he used to dissolve into the window mullions when he
crossed. He now carries a knockout: a second sheet of himself filled in the
ground colour, drawn under his sprite, so scenery is covered by his silhouette
rather than showing through his head. Generated by `scripts/dev/make-solid.mjs`.
